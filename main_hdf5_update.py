...
import u3 #LabJack #Non-needed because no more olfactometer
...
def crop_w_mouse(img):
        ...
        mmc.setROI(x,y,w,h)
        """[[35, 9], [405, 531]]
selectROI x 35 y 9 w 370 h 522 """
...
#                    break
            ...
            if i < rep:
                    ...
                    frames[:]=[]
                    text_file.close()
                    print ("wating "+str(window.dur_2.value())+" s")
                    time.sleep(window.dur_2.value())
            count =1
...
if __name__ == '__main__':
    ...
    mmc.setProperty('Zyla','ElectronicShutteringMode','Global') #Global
    mmc.setProperty('Zyla','Overlap','Off') #Off
