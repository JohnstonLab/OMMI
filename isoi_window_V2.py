...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitAllBtn_2 = QtWidgets.QPushButton(self.groupBox_4)
        self.splitAllBtn_2.setGeometry(QtCore.QRect(280, 100, 151, 23))
        self.splitAllBtn_2.setObjectName("splitAllBtn_2")
        ...
        self.subDirList_2 = QtWidgets.QListWidget(self.groupBox_4)
        self.subDirList_2.setGeometry(QtCore.QRect(10, 50, 256, 151))
        self.subDirList_2.setObjectName("subDirList_2")
        self.experimentFolderName = QtWidgets.QLabel(self.groupBox_4)
        self.experimentFolderName.setGeometry(QtCore.QRect(150, 20, 111, 16))
        self.experimentFolderName.setObjectName("experimentFolderName")
        self.splitBtn_2 = QtWidgets.QPushButton(self.groupBox_4)
        self.splitBtn_2.setGeometry(QtCore.QRect(280, 60, 151, 23))
        self.splitBtn_2.setObjectName("splitBtn_2")
        self.loadJsonBtn = QtWidgets.QPushButton(self.groupBox_4)
        self.loadJsonBtn.setGeometry(QtCore.QRect(460, 20, 135, 23))
        self.loadJsonBtn.setObjectName("loadJsonBtn")
        self.subDirList_3 = QtWidgets.QListWidget(self.groupBox_4)
        self.subDirList_3.setGeometry(QtCore.QRect(460, 50, 231, 151))
        self.subDirList_3.setObjectName("subDirList_3")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.splitAllBtn_2.setText(_translate("MainWindow", "Process whole folder"))
        ...
        self.splitBtn_2.setText(_translate("MainWindow", "Split channels and .txt files"))
        self.loadJsonBtn.setText(_translate("MainWindow", "Load Stim Sequence File"))
